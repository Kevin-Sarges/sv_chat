...
import 'package:new_chat/components/common_widgets.dart';
import 'package:new_chat/constants/all_constants.dart';
import 'package:new_chat/model/chat_messages.dart';
        ...
        children: [
          ...
          Flexible(
            child: TextField(
              ...
              decoration:
                  kTextInputDecoration.copyWith(hintText: 'escreva aqui...'),
              onSubmitted: (value) {
